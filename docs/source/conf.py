# -*- coding: utf-8 -*-
#
# weblocks-navigation-widget documentation build configuration file, created by
...
cl_systems = [
    {
        'name': 'weblocks-navigation-widget-test',
...
project = u'weblocks-navigation-widget'
copyright = u'2017, '
...
htmlhelp_basename = 'weblocks-navigation-widgetdoc'
...
latex_documents = [
  ('index', 'weblocks-navigation-widget.tex', u'weblocks-navigation-widget Documentation',
   u'', 'manual'),
]
...
man_pages = [
    ('index', 'weblocks-navigation-widget', u'weblocks-navigation-widget Documentation',
     [u''], 1)
]
...
texinfo_documents = [
  ('index', 'weblocks-navigation-widget', u'weblocks-navigation-widget Documentation',
   u'', 'weblocks-navigation-widget', 'A container widget which switches between children widgets when user changes an url.',
   'Miscellaneous'),
]
